...
export const QA_PAYMENT_METHODS = [
  ...
  { id: 'kicard', icon: 'credit-card', label: 'كي كارد — مصرف الرافدين', hint: 'أو تطبيق سوبر كي',
    rows: [['رقم البطاقة', '5213720104164616'], ['رقم الحساب', '2901629374'], ['رقم الهاتف', '07715590003'], ['الاسم', 'Mr. Saad Ali Mohammed']],
