...
export const defaultContent = {
  // Homepage cinematic hero — slides are uploaded in the dashboard.
  hero: { slides: [], kickerAr: '', kickerEn: '', titleAr: '', titleEn: '', subtitleAr: '', subtitleEn: '' },
...
function mergeWithDefaults(saved) {
  ...
  return {
    ...
    hero: { ...defaultContent.hero, ...(saved.hero || {}), slides: Array.isArray(saved.hero?.slides) ? saved.hero.slides : [] },
  };
}
