...
export const CATS = [
  ...
  { id: 'couples', icon: 'heart', ar: 'أزواج', en: 'Couples', blurbAr: 'أجواء رومانسية للأزواج والمناسبات الخاصة.', blurbEn: 'Romantic settings for couples and special occasions.' },
  ...
  { id: 'beach', icon: 'map-pin', ar: 'شواطئ', en: 'Beach', blurbAr: 'للباحثين عن الشمس والرمال والمياه الزرقاء.', blurbEn: 'For sun-seekers chasing sand and blue water.' },
