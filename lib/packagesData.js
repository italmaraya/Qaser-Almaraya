...
// Prices are stored in IQD (same convention as visa prices) and formatted
// with lib/currency.js's formatPrice/formatSignedPrice — see the packages
// pages for usage. The numbers in SEED_PACKAGES below are authored in plain
// USD for readability; lib/db.js converts them to IQD at insert time.
...
export const CATS = [
  ...
  { id: 'honeymoon', icon: 'heart', ar: 'شهر العسل', en: 'Honeymoon', blurbAr: 'أجواء رومانسية للعرسان وبداية حياة جديدة.', blurbEn: 'Romantic getaways for newlyweds.' },
  { id: 'music', icon: 'calendar-check', ar: 'حفلات موسيقية', en: 'Musical events', blurbAr: 'سفر منظم حول موعد الحفل مع التذاكر والإقامة.', blurbEn: 'Travel built around the concert date, tickets and stay included.' },
  { id: 'sports', icon: 'calendar-check', ar: 'رياضة', en: 'Sports', blurbAr: 'مباريات وبطولات مع التذاكر والتنقلات.', blurbEn: 'Matches and tournaments with tickets and transfers.' },
  { id: 'umrah', icon: 'moon', ar: 'حج وعمرة', en: 'Hajj & Umrah', blurbAr: 'برامج روحية بإقامة قريبة من الحرمين.', blurbEn: 'Spiritual programs with stays close to the Haramain.' },
];
...
export const SEED_PACKAGES = [
  ...
  {
    cat: 'family', countries: ['ae'], destAr: 'دبي', destEn: 'Dubai',
  ...
  {
    cat: 'music', countries: ['ae'], destAr: 'أبوظبي', destEn: 'Abu Dhabi',
  ...
  {
    cat: 'family', countries: ['ge'], destAr: 'تبليسي وباتومي', destEn: 'Tbilisi & Batumi',
...
export const T = {
  ar: {
    ...
    pdf_btn: 'تحميل PDF لهذه الباقة', copy_btn: 'نسخ التفاصيل', copied_msg: 'تم نسخ تفاصيل الباقة',
  },
  en: {
    ...
    pdf_btn: 'Download PDF for this package', copy_btn: 'Copy details', copied_msg: 'Package details copied',
  },
};
...
// Hotel meal plans shown on the package PDF (stored per hotel as `meal`).
export const MEAL_PLANS = {
  RO: { ar: 'بدون وجبات', en: 'Room only' },
  BB: { ar: 'مع الإفطار', en: 'Bed & breakfast' },
  HB: { ar: 'نصف إقامة (إفطار + عشاء)', en: 'Half board' },
  FB: { ar: 'إقامة كاملة (3 وجبات)', en: 'Full board' },
