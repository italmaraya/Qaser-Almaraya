                  ...
                  <div style={{ alignSelf: 'stretch', maxWidth: 178, padding: 11, background: '#fff', borderRadius: 12, boxShadow: '0 14px 26px rgba(1,42,55,.28)', display: 'flex', flexDirection: 'column', gap: 6, animation: 'qa-swing 5.6s ease-in-out infinite', transformOrigin: '50% 0' }}>
                    ...
                    <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                      ...
                      <span style={{ display: 'flex', flexDirection: 'column', gap: 4, flex: 1 }}>
                        <span style={{ height: 7, borderRadius: 4, background: '#d9edf5' }} />
                        <span style={{ height: 7, width: '66%', borderRadius: 4, background: '#eef1f2' }} />
                      </span>
                    </span>
                  </div>
              ...
              <div style={{ position: 'relative', background: '#fff', borderRadius: 24, boxShadow: '0 24px 50px rgba(1,42,55,.28)' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 14, padding: '18px 26px', background: '#f8fdfe' }}>
                  ...
                  <div style={{ textAlign: 'left' }}>
                    ...
                    <div style={{ fontSize: 22, fontWeight: 700, color: '#049dc5' }}>{estimatedTotal != null ? formatPrice(estimatedTotal, 'IQD', lang) : '—'}</div>
                  </div>
                </div>
              </div>
            </div>
